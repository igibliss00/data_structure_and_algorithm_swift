...
extension Trie {
    ...
    func remove(word: String) {
        ...
        if terminalNode.isLeaf {
            ...
            /// if the terminal node is not a leaf, that means the current word is part of another word
            /// Only eliminate the terminating marker for the word to belong to the bigger word.
