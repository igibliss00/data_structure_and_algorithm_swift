...
public typealias SortFunction = ([Int]) -> [Int]
...
public func checkSortAlgorithm(_ sortFunction: SortFunction) {
...
public func checkSortAlgorithm(_ sortFunction: @escaping ([Int], (Int, Int) -> Bool) -> [Int]) {
